...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sentencepiece_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_sentencepiece_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::sentencepiece::NBestSentencePieceText* Arena::CreateMaybeMessage<::sentencepiece::NBestSentencePieceText>(Arena*);
template <>
::sentencepiece::SentencePieceText* Arena::CreateMaybeMessage<::sentencepiece::SentencePieceText>(Arena*);
template <>
::sentencepiece::SentencePieceText_SentencePiece* Arena::CreateMaybeMessage<::sentencepiece::SentencePieceText_SentencePiece>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class SentencePieceText_SentencePiece final :
 ...
 public:
  ...
  void set_allocated_surface(std::string* ptr);
  ...
  inline bool HasExtension(
      const ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<SentencePieceText_SentencePiece, _proto_TypeTraits,
...
class SentencePieceText final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::sentencepiece::SentencePieceText_SentencePiece>& _internal_pieces() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::sentencepiece::SentencePieceText_SentencePiece>* _internal_mutable_pieces();
  public:
  ...
  template <typename _proto_TypeTraits, ::PROTOBUF_NAMESPACE_ID::internal::FieldType _field_type,
            bool _is_packed>
  inline bool HasExtension(
      const ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier<SentencePieceText, _proto_TypeTraits,
                                       _field_type, _is_packed>& id) const {
    return _impl_._extensions_.Has(id.number());
  }
...
class NBestSentencePieceText final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::sentencepiece::SentencePieceText>& _internal_nbests() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::sentencepiece::SentencePieceText>* _internal_mutable_nbests();
  public:
...
inline PROTOBUF_ALWAYS_INLINE void SentencePieceText_SentencePiece::set_surface(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.surface_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void SentencePieceText_SentencePiece::set_allocated_surface(std::string* value) {
  ...
  _impl_.surface_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline ::sentencepiece::SentencePieceText* NBestSentencePieceText::_internal_add_nbests() {
  return _internal_mutable_nbests()->Add();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_sentencepiece_2eproto_2epb_2eh
