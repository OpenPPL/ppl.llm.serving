...
#ifndef __PPL_LLM_LLAMA3_TOKENIZER_H__
#define __PPL_LLM_LLAMA3_TOKENIZER_H__
...
class Llama3Tokenizer final : public Tokenizer {
public:
    Llama3Tokenizer(TokenizerImpl* impl) {
