...
#ifndef __PPL_LLM_TOKENIZER_IMPL_H__
#define __PPL_LLM_TOKENIZER_IMPL_H__
...
public:
    ...
    virtual ppl::common::RetCode Init(const std::string& path, const std::string& conifg_path = "") = 0;
